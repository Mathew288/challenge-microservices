package com.ntt.ms_clientes.adapters.in.web;
...
import com.ntt.ms_clientes.config.CorrelationIdFilter;
...
public class ApiExceptionHandler {
	...
	public ApiResponse<Void> handleNotReadable(HttpMessageNotReadableException ex) {
		// JSON mal formado o tipos incompatibles
		return ApiResponse.error(
				HttpStatus.BAD_REQUEST.value(),
				"BAD_REQUEST",
	...
	public ApiResponse<Void> handleGeneric(Exception ex) {
		// Fallback: evita que Spring devuelva su JSON por defecto (timestamp/status/error/path)
		return ApiResponse.error(
